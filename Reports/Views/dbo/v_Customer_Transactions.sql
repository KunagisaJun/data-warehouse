...
AS
SELECT
    /* dim.Customer (customer grain attributes) */
    [dwh_dim_customer].[customer_sk]      AS [dwh_dim_customer_customer_sk],
    ...
    /* dim.Account (route customer -> accounts; include account attributes) */
